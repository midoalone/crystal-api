...
<head>
  ...
  <style type="text/css">
    ...
    *{
    ...
    .ExternalClass
    {width: 100%; background-color: #ffffff;}
    body{width: 100%; height: 100%; background-color: #ffffff; margin:0; padding:0; -webkit-font-smoothing: antialiased;direction: rtl;}
          ...
          <tr>
            <td width="100%" height="100" align="center">
              ...
              <table  border="0" cellpadding="0" cellspacing="0" align="center" class="fullCenter" object="drag-module-small">
                <tr>
                  <td width="100%" style="width:80px; height:auto;">
                    <a href="#" style="text-decoration: none;"><img src="https://api.baeynh.com/images/logo.png" width="80" alt="" border="0" class="hover" ></a>
                  </td>
                </tr>
              </table><!-- End Logo -->
                            ...
                            <table width="300" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                              ...
                              <tr>
                                <td width="100%" style="width:329px; height:auto;" class="fullCenter">
                                  <img src="https://api.baeynh.com/images/icon.png" width="329" alt="illustration" border="0" class="hover" class="fullCenter">
                                </td>
                              </tr>
                              <tr>
                      ...
                      <table width="400" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile" bgcolor="#ffffff"object="drag-module-small">
                        <tr>
                          <td width="100%" valign="middle" align="center">
                            ...
                            <table width="300" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                              <tr>
                                <td valign="middle" width="100%" style="text-align: center; font-family: 'Cairo', Helvetica, Arial, sans-serif; font-size: 20px; color: #353535; line-height: 40px; font-weight: 400;direction: rtl;" class="fullCenter" >
                                  مرحبا <span style="color:#00d4ff;">{{$name}}</span>
                                </td>
                              </tr>
                            </table>
                        ...
                        <tr>
                          <td width="100%" valign="middle" align="center">
                            ...
                            <table width="300" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="">
                              <tr>
                                <td valign="middle" width="100%" style="text-align: center; font-family: 'Cairo', Helvetica, Arial, sans-serif; font-size: 16px; color: #868585; line-height: 24px; font-weight: 400;" class="" >
                                  {{$text}}
                                </td>
                              </tr>
                            </table>
              ...
              <table width="352" border="0" cellpadding="0" cellspacing="0" align="center" class="full" object="drag-module-small">
                ...
                <tr>
                  <td valign="middle" width="100%" style="text-align: center; font-family: 'Cairo', Helvetica, Arial, sans-serif; color: rgb(165, 168, 174); font-size: 12px; font-weight: 400; line-height: 18px;" class="fullCenter" >
                    جميع الحقوق محفوظة لـcopyrights
                  </td>
                </tr>
              </table>
...
{{--                    <!--subscribe--><a href="#" style="text-decoration: none; color: #00d4ff;">Unsubscribe</a><!--unsub-->--}}
{{--                  </td>--}}
{{--                </tr>--}}
{{--              </table>--}}
